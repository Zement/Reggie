...
from reggie.plugins.quickpaint.core.modes import SmartPaintMode, SingleTileMode, ShapeCreator, PaintingDirection
...
class QuickPaintWidget(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        from reggie.plugins.quickpaint.ui.tile_picker_canvas import TilePickerCanvas
