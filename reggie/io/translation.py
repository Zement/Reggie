...
class ReggieTranslation:
    ...
    def InitAsEnglish(self):
        ...
        self.strings = {
            'AboutDlg': {
                0: 'About Reginald',
                1: '[i]Reginald[/i] Level Editor',
                2: '[i]Reginald[/i] is the continuation of [i]Reggie! Next[/i], an open-source project started by Treeki in 2010 and forked by RoadrunnerWMC in 2013, that aims to bring you the fun of designing original New Super Mario Bros. Wii[tm]-compatible levels.[br]',
            ...
            'MenuItems': {
                ...
                18: 'Reginald Preferences...',
                19: 'Change important Reginald settings',
                20: 'Exit Reginald',
                21: 'Exit the editor',
                22: 'Select All',
                ...
                92: 'About PyQt...',
                93: 'About the Qt library Reginald is based on',
                94: 'Level Overview',
                95: 'Show or hide the Level Overview window',
                96: 'Palette',
                97: 'Show or hide the Palette window',
                98: 'Change Game',
                99: 'Change the currently loaded Reginald game patch',
                ...
                156: 'Nothing to do in bulk: a level that has never been saved needs a file name first.',
                157: 'Save',
                158: 'Discard',
                159: 'Discard All',
                160: 'A level that has never been saved has nothing on disk to go back to.',
                161: 'Discard changes?',
                ...
                165: 'Collaborate',
                166: '[count] levels have unsaved changes.',
                167: 'Save or discard them all, or cancel to handle them one at a time in the Unsaved Levels list.',
            },
            'Objects': {
            ...
            'PrefsDlg': {
                0: 'Reginald Preferences',
                1: 'General',
                2: 'Toolbar',
                3: 'Appearance',
                4: '[b]Reginald Preferences[/b][br]Customize Reginald by changing these settings.[br]Use the tabs below to view even more settings.[br]Reginald must be restarted before certain changes can take effect.',
                5: '[b]Toolbar Preferences[/b][br]Choose menu items you would like to appear on the toolbar.[br]Reginald must be restarted before the toolbar can be updated.[br]',
                6: '[b]Reginald Appearance[/b][br]Customize the appearance of Reginald by changing these settings.[br]Reginald must be restarted before the theme can be changed.',
                ...
                22: 'Preview',
                23: None,
                24: '[b]Window Style[/b][br]This changes what style Reginald\'s UI uses. Note that this may cause issues with certain themes.',
                25: 'Window Style:',
                ...
                30: 'You may need to restart Reginald for changes to take effect.',
                ...
                47: 'Dark Mode',
                48: '[b]Dark Mode[/b][br]This determines the overall color style Reginald uses, independent from the current theme.[br][br]Note that this may cause issues with certain themes.',
            ...
            'Themes': {
                0: 'Classic',
                1: 'Treeki, Tempus',
                2: 'The default Reginald theme.',
                3: '[i](unknown)[/i]',
                4: '[i]No description[/i]',
            },
            'Undo': {
                # Undo history UI (Block C - A1)
                0: 'Undo History...',
                1: 'View the list of editing steps in this session',
                2: 'Undo History',
                3: '<Level loaded>',
                4: 'History size (steps):',
                5: 'Maximum number of editing steps kept in the history. The oldest steps are dropped when the history is full. A smaller limit takes effect fully after the next level load or save.',
                6: 'Configure the undo/redo history.',
                # Item labels used inside step descriptions
                10: 'object [ts]-[type]',
                11: 'sprite [id]',
                12: 'entrance [id]',
                13: 'location [id]',
                14: 'path [path] node [node]',
                15: 'comment',
                16: 'zone [id]',
                17: 'item',
                18: '[n] items',
                ...
                28: 'Shift items',
                29: 'Merge locations',
                30: 'Swap tilesets [from] and [to]',
                31: 'Swap object types',
                32: 'Replace sprite with [id]',
                33: 'Replace [n] sprites with sprite [id]',
                34: 'Edit sprite [id] data',
                35: 'Edit comment',
                36: 'Snap location [id] to grid',
                37: 'Move & resize [n] items',
                38: 'Reorder path [id] node',
                39: 'Edit path [id] [setting]',
                # Modal dialogs
                50: 'Edit zones',
                51: 'Edit area settings',
                52: 'Edit backgrounds',
                53: 'Edit camera profiles',
                54: 'Edit level information',
            },
            'WindowTitle': {
                0: 'Untitled',
            },
